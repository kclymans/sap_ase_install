##############################################################################
# Sample responses file for SAP Adaptive Server Enterprise 16.0 SP02.
#
...
#
USER_INSTALL_DIR={{ sybase_software_dir }}
...
CHOSEN_FEATURE_LIST=fase_srv,fopen_client,fdblib,fjconnect160,fdbisql,fqptune,fsysam_util,fodbcl,fconn_python,fconn_perl
...
#
# Note:
# - 'developer', 'evaluate' and 'express' only available on some platforms.
#
...
#--------------------------------------------
# SYSAM_PRODUCT_EDITION=<Enterprise Edition|Developer Edition|Small Business Edition|Unknown>
...
#		Unknown
#	Valid SYSAM_LICENSE_TYPE value for SYSAM_PRODUCT_EDITION='Developer Edition' or SYSAM_PRODUCT_EDITION=Unknown
#		None
#
...
UPDATE_ASE_PASSWORD_1=Sybase123
UPDATE_ASE_SERVER_NAME_2=SYBASE2
UPDATE_ASE_PASSWORD_2=Sybase123
...
COCKPIT_TECH_USER_PASSWORD=Sybase123
...
CONFIG_SCC_CSI_SCCADMIN_PWD=Sybase123
CONFIG_SCC_CSI_UAFADMIN_USER=uafadmin
CONFIG_SCC_CSI_UAFADMIN_PWD=Sybase123
CONFIG_SCC_REPOSITORY_PWD=Sybase123
